...
```shell
wget https://github.com/josepdcs/kubectl-prof/releases/download/1.10.0/kubectl-prof_1.10.0_linux_amd64.tar.gz
tar xvfz kubectl-prof_1.10.0_linux_amd64.tar.gz
...
```shell
wget https://github.com/josepdcs/kubectl-prof/releases/download/1.10.0/kubectl-prof_1.10.0_darwin_amd64.tar.gz
tar xvfz kubectl-prof_1.10.0_darwin_amd64.tar.gz
sudo install kubectl-prof /usr/local/bin/
```
