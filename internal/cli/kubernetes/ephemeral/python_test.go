...
func Test_pythonCreator_Create(t *testing.T) {
	// Given
	targetPod := &v1.Pod{
	...
	expected := &v1.EphemeralContainer{
		EphemeralContainerCommon: v1.EphemeralContainerCommon{
			...
			Args:    []string{"--target-container-runtime", "ContainerRuntime", "--target-container-runtime-path", "ContainerRuntimePath", "--target-pod-uid", "UID", "--target-container-id", "ContainerID", "--lang", "Language", "--event-type", "Event", "--compressor-type", "Compressor", "--profiling-tool", "", "--output-type", "", "--grace-period-ending", "0s", "--duration", "100ns"},
