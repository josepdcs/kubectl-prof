...
func TestNewCreator(t *testing.T) {
	assert.IsType(t, &creator{}, NewCreator(testclient.NewSimpleClientset()))
}
...
func (m *mockCreator) Create(targetPod *v1.Pod, cfg *config.ProfilerConfig) (string, *batchv1.Job, error) {
